...
/**
* If data_ptr in markov_chain, return it is node. Otherwise, create new
 ...
 * If already in list, update it is occurrence frequency value.
 * @param first_node
 * @param second_node
...
/**
 * Choose randomly the next MarkovNode, depend on it is occurrence frequency.
...
/**
 * Receive word and check if  there is a dot in the end.
 * @param word a word
 *return bool
 */
